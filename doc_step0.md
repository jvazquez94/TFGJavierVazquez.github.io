...
![image](https://user-images.githubusercontent.com/36034121/224068798-4466ddc3-79c8-48b2-a88c-bba1732fcee7.png)
  ...
  *22-03-2023*
  ...
  ```html <a-mixin> ``` dentro de los ```html <a-asssets> ```. Ya que es gracias a la previa definicion de estos podemos reutilizar elementos. Es como definir un prefab de Unity.
